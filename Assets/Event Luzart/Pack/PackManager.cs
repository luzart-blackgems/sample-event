namespace Luzart
{
    ...
    public class PackManager : Singleton<PackManager>
    {
        ...
        public void CalculateShowPack()
        {
            ...
            //for (int i = 0; i < length; i++)
            //{
            //    string strPack = FirebaseWrapperLog.GetStringIAP(ePackCurrent[i]);
            //    FirebaseWrapperLog.LogIAPShow(TypeFirebase.TypeShowIAP.Button, strPack);
            //}
        }
...
#if UNITY_EDITOR && ODIN_INSPECTOR
        [Sirenix.OdinInspector.ValueDropdown(nameof(GetPackWhereValues))]
#endif
        public string where;
